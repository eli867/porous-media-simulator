...
export default function CommandsPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-zinc-50 py-12 px-2">
      <section className="w-full max-w-xl mx-auto bg-white rounded-xl border border-zinc-200 shadow-lg p-8">
        <h1 className="text-2xl font-serif font-bold text-zinc-900 mb-2 text-center">Fluid Permeability Simulation</h1>
